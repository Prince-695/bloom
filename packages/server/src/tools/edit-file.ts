...
export function createEditFileTool(cwd: string) {
    return tool({
        description: "Make a targeted edit to a file by making an exact string match. The oldString must appear exactily once in the file (for safety). Use this for surgical edits instead of rewriting the entire files.",
